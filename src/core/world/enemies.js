...
const enemyPools = {
    ...
    // MAPA 4: DESERTO INCANDESCENTE (Nível 18-30)
    ...
    // MAPA 5: CITADELA LUNAR (Nível 25-40)
    citadela_lunar: {
        common: [
            {
                id: 'lunar_sentry',
    ...
    // MAPA 6: ABISMO DE NOCTRA (Nível 35+)
    abismo_noctra: {
        common: [
            {
                id: 'void_spawn',
        ...
        miniboss: [
            {
                ...
                name: 'Draco do Vazio',
                emoji: '🐉',
                hp: 1300, atk: 110, def: 75, crit: 22,
                xp: 700, gold: 550,
                isMiniBoss: true,
        ...
        boss: [
            {
                ...
                emoji: '🌑',
                hp: 1800, atk: 130, def: 90, crit: 25,
                xp: 1200, gold: 1000,
                isBoss: true,
